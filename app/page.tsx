...
export default function Home() {
  return (
    <main className="m-3">
      ...
      <div className="md:max-w-screen-xl md:m-auto md:pt-40">
        <div className="grid grid-cols-1 md:grid-cols-2 h-[40vh]">
          ...
          <div className="grid place-content-center items-center">
            ...
            <div className="flex overflow-x-auto md:block md:overflow-x-clip">
              <pre className="bg-[#0a121b] text-white p-6 text-base md:text-xl rounded-lg mt-10">
